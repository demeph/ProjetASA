...
public class BindingImpl extends MinimalEObjectImpl.Container implements Binding {
	...
	public NotificationChain basicSetPortProvided(Port newPortProvided, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CosaPackage.BINDING__PORT_PROVIDED, oldPortProvided, newPortProvided);
	...
	public void setPortProvided(Port newPortProvided) {
		if (newPortProvided != portProvided) {
			...
			if (portProvided != null)
				msgs = ((InternalEObject)portProvided).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CosaPackage.BINDING__PORT_PROVIDED, null, msgs);
			if (newPortProvided != null)
				msgs = ((InternalEObject)newPortProvided).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CosaPackage.BINDING__PORT_PROVIDED, null, msgs);
			msgs = basicSetPortProvided(newPortProvided, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CosaPackage.BINDING__PORT_PROVIDED, newPortProvided, newPortProvided));
	}
	...
	public NotificationChain basicSetPortRequired(Port newPortRequired, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CosaPackage.BINDING__PORT_REQUIRED, oldPortRequired, newPortRequired);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPortRequired(Port newPortRequired) {
		if (newPortRequired != portRequired) {
			...
			if (portRequired != null)
				msgs = ((InternalEObject)portRequired).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CosaPackage.BINDING__PORT_REQUIRED, null, msgs);
			if (newPortRequired != null)
				msgs = ((InternalEObject)newPortRequired).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CosaPackage.BINDING__PORT_REQUIRED, null, msgs);
			msgs = basicSetPortRequired(newPortRequired, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CosaPackage.BINDING__PORT_REQUIRED, newPortRequired, newPortRequired));
	}
