...
/**
 * This is the item provider adapter for a {@link fr.univnantes.asa.cosa.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CosaPackage.Literals.CONNECTOR__ROLES);
			childrenFeatures.add(CosaPackage.Literals.CONNECTOR__GLUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CosaPackage.Literals.CONNECTOR__ROLES, CosaFactory.eINSTANCE.createRole()));

		newChildDescriptors.add(createChildParameter(CosaPackage.Literals.CONNECTOR__ROLES,
				CosaFactory.eINSTANCE.createRequiredRole()));

		newChildDescriptors.add(createChildParameter(CosaPackage.Literals.CONNECTOR__ROLES,
				CosaFactory.eINSTANCE.createProvidedRole()));

		newChildDescriptors
				.add(createChildParameter(CosaPackage.Literals.CONNECTOR__GLUE, CosaFactory.eINSTANCE.createGlue()));
	}
