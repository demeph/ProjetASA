...
public class CosaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CosaPackage.REQUIRED_PORT: {
			...
			if (result == null)
				result = caseNamedElement(requiredPort);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CosaPackage.PROVIDED_PORT: {
			...
			if (result == null)
				result = caseNamedElement(providedPort);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CosaPackage.REQUIRED_SERVICE: {
			...
			if (result == null)
				result = caseNamedElement(requiredService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CosaPackage.PROVIDED_SERVICE: {
			...
			if (result == null)
				result = caseNamedElement(providedService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CosaPackage.SIMPLE_CONFIGURATION: {
			...
			if (result == null)
				result = caseConfiguration(simpleConfiguration);
			if (result == null)
				result = caseNamedElement(simpleConfiguration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case CosaPackage.COMPOSITE_CONFIGURATION: {
			...
			if (result == null)
				result = caseConfiguration(compositeConfiguration);
			if (result == null)
				result = caseNamedElement(compositeConfiguration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
